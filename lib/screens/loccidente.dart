...
class LoccidenteWidget extends StatefulWidget {
  @override
  _LoccidenteWidgetState createState() => _LoccidenteWidgetState();
}

class _LoccidenteWidgetState extends State<LoccidenteWidget> {
